...
\mark \markup { \bold \rounded-box { "C" } } \section
s1*4 \break
...
\numericTimeSignature\time 4/4
\repeat unfold 2 { s1*4 \break }
s1*3 \mark \markup { \musicglyph "scripts.varcoda" } s1 \break
...
r4 a2  gs8 fs8 | e4 cs8 a8~8 cs8~8 b8~|1~|2 r2 |
r4 a'2 gs8 fs8 | e4 cs8 a8~8 cs8~8 b8~|1~|2 fs'8 a b a |

\repeat volta 2 {
cs1~| 2 8 e8 \tuplet 3/2 { b16 c b } a8 | b1~| b2 fs8 a b a|
cs1~| 2 8 e8 \tuplet 3/2 { b16 c b } a8 | fs1 | r4 e4 d8 e~8 fs ~|
fs1~| 2.. 8~| 2 d8 e~e fs~| 2 8 a b a |

cs1~|2 8 e \tuplet 3/2 { b16 c b } a8 | b1~ | 2 fs8 a b a |
...
\repeat unfold 6 { bs16 cs16 r8 } bs16 cs16 fs8 \tuplet 3/2 { b,16 c b } a8 |
fs1 | r4 e d8 e~e fs~ |
4. b4. cs4 ~|4 d2~d8 ds8~|4. fs4. g4 ~| 1| }
